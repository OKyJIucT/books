        ...
        if ($data->versions) {
            ...
            foreach ($data->versions as $version) {
                ...
                if ($version->user_id != Yii::app()->user->id) {
                    ...
                    echo '<span class="label label-pink btn-translate-left">' . $version->user->username . '</span>';
                    echo '<span class="label label-pink btn-translate-right">Сохранено: ' . date("d-M-Y, H:i", $version->date) . '</span>';
