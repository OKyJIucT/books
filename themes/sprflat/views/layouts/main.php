...
<head>
    ...
    <!-- Css files -->
    <?php
    Yii::app()->clientScript->registerCssFile('/static/css/main.min123.css');
                    ...
                    <?php if (Y::hasAccess('administrator')) : ?>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu email" role="menu">
                                ...
                                <li>
                                    <a href="<?= Y::url('/site/clearCache'); ?>"><i class="fa-trash"></i> Очистить
                                        кеш</a>
                                </li>
                                <li>
                                    <a href="<?= Y::url('/site/getInvites'); ?>"><i class="fa-key"></i> Сгенерировать
                                        инвайты</a>
                                </li>
                            </ul>
                        </li>
