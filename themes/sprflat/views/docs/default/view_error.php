...
<div class="col-md-12">
    <h2><?= $model->title; ?> <?php if ($model->type) echo '<span class="fa-lock text-danger" data-toggle="tooltip" data-placement="right" data-original-title="Приватный документ"></span>'; ?></h2>
...
<div class="col-md-10 form-horizontal">
    ...
    <div class="btn-group mtop mbottom">
        ...
        echo '<div class="btn btn-danger"><i class="fa-lock"></i> Нет доступа к данному документу</div> ';
