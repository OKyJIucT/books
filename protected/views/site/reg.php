<div class="login-container lightmode">
    ...
    <div class="login-box animated fadeInDown">
        <div class="login-body">
            ...
            <div class="row">
                <?php echo CHtml::submitButton('Зарегистрироваться', array('class' => 'btn btn-success btn-block col-lg-6')); ?>

                <a href="/login" class="btn btn-warning btn-block col-lg-6">Авторизация</a>
            </div>
