        ...
        <ul class="x-navigation x-navigation-horizontal">
            ...
            <?php if (Y::hasAccess('administrator')) : ?>
                <li class="xn-openable">
                    ...
                    <ul>
                        <li>
                            <a href="<?= Y::url('/rbac/default/index'); ?>"><span class="fa fa-lock"></span> Роли
                                пользователей</a>
                        </li>
                        <li>
                            <a href="<?= Y::url('/site/clearCache'); ?>"><span class="fa fa-trash-o"></span> Очистить
                                кеш</a>
                        </li>
                        <li>
                            <a href="<?= Y::url('/site/getInvites'); ?>"><span class="fa fa-key"></span> Сгенерировать
                                инвайты</a>
                        </li>
                    </ul>
                </li>
            ...
            <li class="xn-openable pull-right <?php echo Yii::app()->controller->module->id == 'users' ? 'hover' : ''; ?>">
                <a href="<?= Y::url('/users'); ?>"><span class="fa fa-user"></span> <span
                        class="xn-text"><?= Yii::app()->user->name; ?></span></a>
                <ul>
                    ...
                    <li <?php echo Yii::app()->controller->module->id == 'users' && $this->action->id == 'index' ? 'class="active"' : ''; ?>>
                        <a href="<?= Y::url('/users/default/view', array('id' => Yii::app()->user->id)); ?>"><span
                                class="fa fa-cogs"></span> Настройки</a>
...
<div id="topcontrol" title="Scroll Back to Top"
     style="position: fixed; bottom: 10px; right: 10px; opacity: 0; cursor: pointer;">
    <!-- TO TOP -->
