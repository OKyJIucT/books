...
$this->beginWidget('zii.widgets.jui.CJuiTabs', array(
    'id' => 'tabs',
    'tabs' => array(
        '<span>' . Yii::t('RbacuiModule.rbacui', 'Доступы') . '</span>' => array('ajax' => $this->createAbsoluteUrl('rbacui/user'), 'id' => 'tab1'),
        '<span>' . Yii::t('RbacuiModule.rbacui', 'Роли') . '</span>' => array('ajax' => $this->createAbsoluteUrl('rbacui/role'), 'id' => 'tab2'),
        '<span>' . Yii::t('RbacuiModule.rbacui', 'Задания') . '</span>' => array('ajax' => $this->createAbsoluteUrl('rbacui/task'), 'id' => 'tab3'),
        '<span>' . Yii::t('RbacuiModule.rbacui', 'Операции') . '</span>' => array('ajax' => $this->createAbsoluteUrl('rbacui/operation'), 'id' => 'tab4'),
        '<span>' . Yii::t('RbacuiModule.rbacui', 'Структура') . '</span>' => array('ajax' => $this->createAbsoluteUrl('rbacui/hierarchy'), 'id' => 'tab5'),
    ),
